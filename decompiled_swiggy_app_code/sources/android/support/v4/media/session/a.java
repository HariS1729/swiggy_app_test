...
public interface a extends IInterface {
    ...
    void E2(ParcelableVolumeInfo parcelableVolumeInfo) throws RemoteException;
    ...
    void S3(PlaybackStateCompat playbackStateCompat) throws RemoteException;

    void W() throws RemoteException;

    void c2(MediaMetadataCompat mediaMetadataCompat) throws RemoteException;

    void i3(boolean z11) throws RemoteException;

    void k2(int i11) throws RemoteException;

    void onRepeatModeChanged(int i11) throws RemoteException;

    void p(String str, Bundle bundle) throws RemoteException;

    void p3(boolean z11) throws RemoteException;

    void q3(CharSequence charSequence) throws RemoteException;
}
