...
public final class MediaMetadataCompat implements Parcelable {
    ...
    static final androidx.collection.a<String, Integer> f1308c;

    /* renamed from: d  reason: collision with root package name */
    private static final String[] f1309d = {"android.media.metadata.TITLE", "android.media.metadata.ARTIST", "android.media.metadata.ALBUM", "android.media.metadata.ALBUM_ARTIST", "android.media.metadata.WRITER", "android.media.metadata.AUTHOR", "android.media.metadata.COMPOSER"};

    /* renamed from: e  reason: collision with root package name */
    private static final String[] f1310e = {"android.media.metadata.DISPLAY_ICON", "android.media.metadata.ART", "android.media.metadata.ALBUM_ART"};

    /* renamed from: f  reason: collision with root package name */
    private static final String[] f1311f = {"android.media.metadata.DISPLAY_ICON_URI", "android.media.metadata.ART_URI", "android.media.metadata.ALBUM_ART_URI"};

    /* renamed from: a  reason: collision with root package name */
    final Bundle f1312a;

    /* renamed from: b  reason: collision with root package name */
    private MediaMetadata f1313b;
    ...
    MediaMetadataCompat(Parcel parcel) {
        this.f1312a = parcel.readBundle(MediaSessionCompat.class.getClassLoader());
    }
    ...
    public static MediaMetadataCompat a(Object obj) {
        ...
        obtain.recycle();
        createFromParcel.f1313b = mediaMetadata;
