...
public final class SentryResponse$$serializer implements q<SentryResponse> {
    ...
    public SentryResponse deserialize(Decoder decoder) {
        ...
        b11.c(descriptor2);
        return new SentryResponse(i11, (String) obj, (x0) null);
    }
    ...
    public void serialize(Encoder encoder, SentryResponse sentryResponse) {
        p.j(encoder, "encoder");
        p.j(sentryResponse, "value");
        SerialDescriptor descriptor2 = getDescriptor();
        d b11 = encoder.b(descriptor2);
        SentryResponse.a(sentryResponse, b11, descriptor2);
        b11.c(descriptor2);
    }
