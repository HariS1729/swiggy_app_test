...
public class ButtonBarLayout extends LinearLayout {
    ...
    private int f1929c = 0;

    public ButtonBarLayout(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        int[] iArr = R.styleable.ButtonBarLayout;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, iArr);
        a0.u0(this, context, iArr, attributeSet, obtainStyledAttributes, 0, 0);
        this.f1927a = obtainStyledAttributes.getBoolean(R.styleable.ButtonBarLayout_allowStacking, true);
    ...
    public int getMinimumHeight() {
        return Math.max(this.f1929c, super.getMinimumHeight());
    }
