...
class g0 {
    ...
    private static final boolean f11906a = true;

    /* renamed from: b  reason: collision with root package name */
    private static final boolean f11907b = true;

    /* renamed from: c  reason: collision with root package name */
    private static final boolean f11908c;

    /* compiled from: TransitionUtils */
    static class a implements TypeEvaluator<Matrix> {

        /* renamed from: a  reason: collision with root package name */
        final float[] f11909a = new float[9];

        /* renamed from: b  reason: collision with root package name */
        final float[] f11910b = new float[9];

        /* renamed from: c  reason: collision with root package name */
        final Matrix f11911c = new Matrix();
        ...
        public Matrix evaluate(float f11, Matrix matrix, Matrix matrix2) {
            matrix.getValues(this.f11909a);
            matrix2.getValues(this.f11910b);
            for (int i11 = 0; i11 < 9; i11++) {
                float[] fArr = this.f11910b;
                float f12 = fArr[i11];
                float[] fArr2 = this.f11909a;
                fArr[i11] = fArr2[i11] + ((f12 - fArr2[i11]) * f11);
            }
            this.f11911c.setValues(this.f11910b);
            return this.f11911c;
        }
    }
    ...
    private static android.graphics.Bitmap b(android.view.View r9, android.graphics.Matrix r10, android.graphics.RectF r11, android.view.ViewGroup r12) {
        ...
        L_0x00a7:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.transition.g0.b(android.view.View, android.graphics.Matrix, android.graphics.RectF, android.view.ViewGroup):android.graphics.Bitmap");
    }
