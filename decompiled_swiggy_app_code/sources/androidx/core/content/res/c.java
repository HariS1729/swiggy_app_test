...
public final class c {
    ...
    private static final ThreadLocal<TypedValue> f9192a = new ThreadLocal<>();
    ...
    private static TypedValue c() {
        ThreadLocal<TypedValue> threadLocal = f9192a;
    ...
    private static int g(int i11, float f11, float f12) {
        ...
        int b11 = a.b((int) ((((float) Color.alpha(i11)) * f11) + 0.5f), 0, 255);
        if (z11) {
            a c11 = a.c(i11);
