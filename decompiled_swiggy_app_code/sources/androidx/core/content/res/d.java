...
public final class d {
    ...
    private final Shader f9193a;

    /* renamed from: b  reason: collision with root package name */
    private final ColorStateList f9194b;
    ...
    public boolean i() {
        /*
            r1 = this;
            android.graphics.Shader r0 = r1.f9193a
            if (r0 != 0) goto L_0x0010
            android.content.res.ColorStateList r0 = r1.f9194b
            if (r0 == 0) goto L_0x0010
    ...
    public boolean j(int[] iArr) {
        if (i()) {
            ColorStateList colorStateList = this.f9194b;
            int colorForState = colorStateList.getColorForState(iArr, colorStateList.getDefaultColor());
            if (colorForState != this.f9195c) {
                this.f9195c = colorForState;
                return true;
            }
        }
        return false;
