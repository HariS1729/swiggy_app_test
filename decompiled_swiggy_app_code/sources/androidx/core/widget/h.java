...
public class h extends a {
    ...
    private final ListView f9662s;

    public h(ListView listView) {
        super(listView);
        this.f9662s = listView;
    }
    ...
    public boolean b(int r8) {
        /*
            r7 = this;
            android.widget.ListView r0 = r7.f9662s
            int r1 = r0.getCount()
            r2 = 0
        ...
        L_0x0039:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.core.widget.h.b(int):boolean");
    }
