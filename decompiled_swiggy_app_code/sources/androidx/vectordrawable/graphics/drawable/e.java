...
public class e {
    ...
    private static class a implements TypeEvaluator<d.b[]> {
        ...
        public d.b[] evaluate(float f11, d.b[] bVarArr, d.b[] bVarArr2) {
            if (d.b(bVarArr, bVarArr2)) {
                if (!d.b(this.f12059a, bVarArr)) {
                    this.f12059a = d.f(bVarArr);
                }
                for (int i11 = 0; i11 < bVarArr.length; i11++) {
                    this.f12059a[i11].d(bVarArr[i11], bVarArr2[i11], f11);
                }
                return this.f12059a;
            }
    ...
    private static Animator a(Context context, Resources resources, Resources.Theme theme, XmlPullParser xmlPullParser, float f11) throws XmlPullParserException, IOException {
    ...
    private static android.animation.Animator b(android.content.Context r18, android.content.res.Resources r19, android.content.res.Resources.Theme r20, org.xmlpull.v1.XmlPullParser r21, android.util.AttributeSet r22, android.animation.AnimatorSet r23, int r24, float r25) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        ...
        L_0x005d:
            ...
            r15.<init>()
            int[] r0 = androidx.vectordrawable.graphics.drawable.a.f12043h
            r7 = r22
            android.content.res.TypedArray r6 = androidx.core.content.res.k.s(r8, r9, r7, r0)
            java.lang.String r0 = "ordering"
            int r16 = androidx.core.content.res.k.k(r6, r10, r0, r14, r14)
            r0 = r18
            r1 = r19
            r2 = r20
            r3 = r21
    ...
    private static int g(Resources resources, Resources.Theme theme, AttributeSet attributeSet, XmlPullParser xmlPullParser) {
        TypedArray s11 = k.s(resources, theme, attributeSet, a.j);
        int i11 = 0;
        TypedValue t = k.t(s11, xmlPullParser, "value", 0);
        if ((t != null) && h(t.type)) {
            i11 = 3;
        }
        s11.recycle();
    ...
    private static ValueAnimator l(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, ValueAnimator valueAnimator, float f11, XmlPullParser xmlPullParser) throws Resources.NotFoundException {
        TypedArray s11 = k.s(resources, theme, attributeSet, a.f12042g);
        TypedArray s12 = k.s(resources, theme, attributeSet, a.k);
        if (valueAnimator == null) {
            valueAnimator = new ValueAnimator();
        }
        q(valueAnimator, s11, s12, f11, xmlPullParser);
        int l11 = k.l(s11, xmlPullParser, "interpolator", 0, 0);
        if (l11 > 0) {
            valueAnimator.setInterpolator(d.a(context, l11));
        }
        s11.recycle();
        if (s12 != null) {
            s12.recycle();
    ...
    private static Keyframe m(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, int i11, XmlPullParser xmlPullParser) throws XmlPullParserException, IOException {
        Keyframe keyframe;
        TypedArray s11 = k.s(resources, theme, attributeSet, a.j);
        float j = k.j(s11, xmlPullParser, "fraction", 3, -1.0f);
        TypedValue t = k.t(s11, xmlPullParser, "value", 0);
        boolean z11 = t != null;
        if (i11 == 4) {
            i11 = (!z11 || !h(t.type)) ? 0 : 3;
        }
        if (z11) {
            if (i11 == 0) {
                keyframe = Keyframe.ofFloat(j, k.j(s11, xmlPullParser, "value", 0, 0.0f));
            } else if (i11 == 1 || i11 == 3) {
                keyframe = Keyframe.ofInt(j, k.k(s11, xmlPullParser, "value", 0, 0));
            } else {
                keyframe = null;
            }
        } else if (i11 == 0) {
        ...
        int l11 = k.l(s11, xmlPullParser, "interpolator", 1, 0);
        if (l11 > 0) {
            keyframe.setInterpolator(d.a(context, l11));
        }
        s11.recycle();
        return keyframe;
    }

    private static ObjectAnimator n(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, float f11, XmlPullParser xmlPullParser) throws Resources.NotFoundException {
    ...
    private static android.animation.PropertyValuesHolder[] p(android.content.Context r17, android.content.res.Resources r18, android.content.res.Resources.Theme r19, org.xmlpull.v1.XmlPullParser r20, android.util.AttributeSet r21) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        ...
        L_0x0016:
            ...
            int[] r0 = androidx.vectordrawable.graphics.drawable.a.f12044i
            r11 = r18
            r12 = r19
            r13 = r21
            android.content.res.TypedArray r14 = androidx.core.content.res.k.s(r11, r12, r13, r0)
            java.lang.String r0 = "propertyName"
            java.lang.String r15 = androidx.core.content.res.k.m(r14, r6, r0, r1)
            r0 = 4
            java.lang.String r1 = "valueType"
            int r5 = androidx.core.content.res.k.k(r14, r6, r1, r2, r0)
            r0 = r17
            r1 = r18
            r2 = r19
            r3 = r20
    ...
    private static void q(ValueAnimator valueAnimator, TypedArray typedArray, TypedArray typedArray2, float f11, XmlPullParser xmlPullParser) {
        long k = (long) k.k(typedArray, xmlPullParser, "duration", 1, OS2WindowsMetricsTable.WEIGHT_CLASS_LIGHT);
        long k11 = (long) k.k(typedArray, xmlPullParser, "startOffset", 2, 0);
        int k12 = k.k(typedArray, xmlPullParser, "valueType", 7, 4);
        if (k.r(xmlPullParser, "valueFrom") && k.r(xmlPullParser, "valueTo")) {
            if (k12 == 4) {
                k12 = f(typedArray, 5, 6);
            }
            PropertyValuesHolder e11 = e(typedArray, k12, 5, 6, "");
            if (e11 != null) {
        ...
        if (typedArray2 != null) {
            r(valueAnimator, typedArray2, k12, f11, xmlPullParser);
        }
    }
    ...
    private static void r(ValueAnimator valueAnimator, TypedArray typedArray, int i11, float f11, XmlPullParser xmlPullParser) {
        ...
        String m11 = k.m(typedArray, xmlPullParser, "pathData", 1);
        if (m11 != null) {
            String m12 = k.m(typedArray, xmlPullParser, "propertyXName", 2);
            String m13 = k.m(typedArray, xmlPullParser, "propertyYName", 3);
            if (i11 != 2) {
            }
            if (m12 == null && m13 == null) {
                throw new InflateException(typedArray.getPositionDescription() + " propertyXName or propertyYName is needed for PathData");
            }
            s(d.e(m11), objectAnimator, f11 * 0.5f, m12, m13);
            return;
        }
