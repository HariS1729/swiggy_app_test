...
interface Writer {
    ...
    void b(int i11, Object obj, y0 y0Var) throws IOException;

    <K, V> void c(int i11, e0.a<K, V> aVar, Map<K, V> map) throws IOException;

    @Deprecated
    void d(int i11, List<?> list, y0 y0Var) throws IOException;

    @Deprecated
    void e(int i11, Object obj, y0 y0Var) throws IOException;

    void f(int i11, List<?> list, y0 y0Var) throws IOException;
    ...
    void writeFixed64(int i11, long j) throws IOException;
    ...
    void writeInt64(int i11, long j) throws IOException;
    ...
    void writeSFixed64(int i11, long j) throws IOException;
    ...
    void writeSInt64(int i11, long j) throws IOException;
    ...
    void writeUInt64(int i11, long j) throws IOException;
