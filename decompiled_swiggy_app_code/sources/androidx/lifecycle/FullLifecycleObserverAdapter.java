...
class FullLifecycleObserverAdapter implements o {
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f10618a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f10618a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f10618a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f10618a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f10618a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f10618a     // Catch:{ NoSuchFieldError -> 0x0054 }
    ...
    FullLifecycleObserverAdapter(h hVar, o oVar) {
        this.f10616a = hVar;
        this.f10617b = oVar;
    }

    public void b(r rVar, Lifecycle.Event event) {
        switch (a.f10618a[event.ordinal()]) {
            case 1:
                this.f10616a.onCreate(rVar);
                break;
            case 2:
                this.f10616a.onStart(rVar);
                break;
            case 3:
                this.f10616a.onResume(rVar);
                break;
            case 4:
                this.f10616a.onPause(rVar);
                break;
            case 5:
                this.f10616a.onStop(rVar);
                break;
            case 6:
                this.f10616a.onDestroy(rVar);
                break;
            case 7:
