...
public final class WindowInsetsPadding_androidKt$navigationBarsPadding$$inlined$windowInsetsPadding$1 extends Lambda implements q<d, g, Integer, d> {
    ...
    public final d a(d dVar, g gVar, int i11) {
        ...
        Object F = gVar.F();
        if (k || F == g.f14172a.a()) {
            F = new InsetsPaddingModifier(c11.d(), (l) null, 2, (i) null);
            gVar.y(F);
        }
        gVar.P();
