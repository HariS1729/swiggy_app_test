...
public class a extends c<Boolean> {
    ...
    private static final String f15269i = i.f("BatteryChrgTracker");
    ...
    public void h(android.content.Context r6, android.content.Intent r7) {
        ...
        L_0x006c:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: j4.a.h(android.content.Context, android.content.Intent):void");
    }
    ...
    public Boolean b() {
        ...
        i.c().b(f15269i, "getInitialState - null intent received", new Throwable[0]);
        return null;
    }
}
