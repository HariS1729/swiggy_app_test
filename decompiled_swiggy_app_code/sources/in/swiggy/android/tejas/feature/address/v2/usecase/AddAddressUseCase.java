...
public final class AddAddressUseCase extends FlowUseCase<PostableAddress, SwiggyApiResponse<AddAddressData>> {
    private final AddressRepository repository;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public AddAddressUseCase(@AddressRepo AddressRepository addressRepository) {
    ...
    public d<Response<SwiggyApiResponse<AddAddressData>>> execute(PostableAddress postableAddress) {
        ...
        return this.repository.addAddress(postableAddress, false);
    }
}
