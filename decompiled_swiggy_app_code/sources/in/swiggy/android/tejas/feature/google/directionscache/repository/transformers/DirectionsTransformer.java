...
public abstract class DirectionsTransformer<P, R> extends FlowModelTransformer<P, R> {
    ...
    public final List<LatLng> decodeEncodedPolyLine(String str) {
        int i11;
        int i12;
    ...
    /* access modifiers changed from: protected */
    public final ArrayList<LatLng> getInterpolatedPath(List<LatLng> list) {
        p.j(list, "latLngList");
    ...
    /* access modifiers changed from: protected */
    public final LatLng interpolate(float f11, LatLng latLng, LatLng latLng2) {
