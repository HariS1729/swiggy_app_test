...
public final class PageSkeletonErrorTransformer extends FlowErrorTransformer<Response, Error> {
    ...
    public d<in.swiggy.android.tejas.Response<Error>> execute(Response response) {
        ...
        return f.x(new PageSkeletonErrorTransformer$execute$1(this, response, (c<? super PageSkeletonErrorTransformer$execute$1>) null));
    }
}
