...
public final class FoodDiscoveryStoreManager_Factory implements e<FoodDiscoveryStoreManager> {
    ...
    public static FoodDiscoveryStoreManager_Factory create(Provider<IDiscoveryAPI> provider, Provider<IDiscoveryJsonApi> provider2, Provider<a> provider3, Provider<IErrorChecker<Response>> provider4, Provider<Map<String, ITransformer<?, ?>>> provider5, Provider<SharedPreferences> provider6, Provider<IStorePersister<FoodDiscoveryRequestParams, d<in.swiggy.android.tejas.Response<ListingResponse>>, StoreTTL>> provider7) {
        return new FoodDiscoveryStoreManager_Factory(provider, provider2, provider3, provider4, provider5, provider6, provider7);
    }

    public static FoodDiscoveryStoreManager newInstance(IDiscoveryAPI iDiscoveryAPI, IDiscoveryJsonApi iDiscoveryJsonApi, a aVar, IErrorChecker<Response> iErrorChecker, Map<String, ITransformer<?, ?>> map, SharedPreferences sharedPreferences, IStorePersister<FoodDiscoveryRequestParams, d<in.swiggy.android.tejas.Response<ListingResponse>>, StoreTTL> iStorePersister) {
        return new FoodDiscoveryStoreManager(iDiscoveryAPI, iDiscoveryJsonApi, aVar, iErrorChecker, map, sharedPreferences, iStorePersister);
    }

    public FoodDiscoveryStoreManager get() {
