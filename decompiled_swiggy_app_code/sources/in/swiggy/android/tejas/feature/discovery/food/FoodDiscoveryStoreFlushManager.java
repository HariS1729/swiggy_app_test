...
/* compiled from: FoodDiscoveryStoreFlushManager.kt */
public final class FoodDiscoveryStoreFlushManager implements SharedPrefFlushManager {
    public static final Companion Companion = new Companion((i) null);
    private static final String LAST_CLEANED_TIME = "food-discovery-store-last-cleaned-time";
    private static final String TAG = "FoodDiscoveryStoreFlushManager";
    ...
    public FoodDiscoveryStoreFlushManager(@FoodDiscoveryStoreSharedPreferences SharedPreferences sharedPreferences2) {
