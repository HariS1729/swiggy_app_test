...
/* compiled from: TextLineTransformer.kt */
public final class TextLineTransformer implements ITransformer<CPPopupWidget.RenderableInfo, TextLine> {
    private final ITransformer<CPPopupWidget.TextStyle, TextStyle> textStyleTransformer;

    public TextLineTransformer(ITransformer<CPPopupWidget.TextStyle, TextStyle> iTransformer) {
