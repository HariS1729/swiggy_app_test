package in.swiggy.android.repositories;
...
public class DataBinderMapperImpl extends e {
    ...
    private static final SparseIntArray f18519a = new SparseIntArray(0);

    private static class a {

        /* renamed from: a  reason: collision with root package name */
        static final SparseArray<String> f18520a;
    ...
    private static class b {
        ...
        /* renamed from: a  reason: collision with root package name */
        static final HashMap<String, Integer> f18521a = new HashMap<>(0);
    }
    ...
    public String convertBrIdToString(int i11) {
        return a.f18520a.get(i11);
    }

    public ViewDataBinding getDataBinder(f fVar, View view, int i11) {
        if (f18519a.get(i11) <= 0 || view.getTag() != null) {
            return null;
        }
    ...
    public int getLayoutId(String str) {
        Integer num;
        if (str == null || (num = b.f18521a.get(str)) == null) {
            return 0;
        }
        return num.intValue();
    }
    ...
    public ViewDataBinding getDataBinder(f fVar, View[] viewArr, int i11) {
        if (viewArr == null || viewArr.length == 0 || f18519a.get(i11) <= 0 || viewArr[0].getTag() != null) {
            return null;
        }
        throw new RuntimeException("view must have a tag");
    }
