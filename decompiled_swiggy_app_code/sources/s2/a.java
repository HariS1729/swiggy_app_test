...
public final class a {
    ...
    private static final String[] f16629a = new String[0];
    ...
    public static String[] a(EditorInfo editorInfo) {
        if (Build.VERSION.SDK_INT >= 25) {
            ...
            return strArr != null ? strArr : f16629a;
        }
        ...
        return stringArray != null ? stringArray : f16629a;
    }
    ...
    public static void e(EditorInfo editorInfo, CharSequence charSequence, int i11) {
        ...
        if (Build.VERSION.SDK_INT >= 30) {
            C0182a.a(editorInfo, charSequence, i11);
            return;
        }
    ...
    public static void f(EditorInfo editorInfo, CharSequence charSequence) {
        if (Build.VERSION.SDK_INT >= 30) {
            C0182a.a(editorInfo, charSequence, 0);
        } else {
